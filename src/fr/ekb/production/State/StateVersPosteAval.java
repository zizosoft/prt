...
import fr.ekb.production.State.StateContainerArrive;
 ...
 * @author abdoulaziz
 */
public class StateVersPosteAval implements AbstractState{
    public void messageOperateur()
    {
    System.out.println("conteneur en envoi vers le poste aval");
    }
   ...
   public AbstractState etatSuivant()
   {
        ...
        return new StateContainerArrive();
    }
